...
object DtaColors {
    ...
    // Customer Ecommerce Benchmark Colors (Reference: media_1788607052048.png)
    val CustomerPrimaryGreen = Color(0xFF009B67)
    val CustomerSecondaryGreen = Color(0xFF00A86B)
    val CustomerDarkGreen = Color(0xFF075E45)
    val CustomerPromoDarkGreen = Color(0xFF034A36)
    val CustomerBgWhite = Color(0xFFFFFFFF)
    val CustomerSurfaceSecondary = Color(0xFFF7F8FA)
    val CustomerSurfaceSearch = Color(0xFFF4F6F8)
    val CustomerTextPrimary = Color(0xFF111827)
    val CustomerTextSecondary = Color(0xFF667085)
    val CustomerTextMuted = Color(0xFF98A2B3)
    val CustomerBorder = Color(0xFFE7EAEC)
    val CustomerPillActiveGreen = Color(0xFFE6F7F0)
